...
class BaseClient(object):
    ...
    def _patch_json(self, url: Text, params, **kwargs) -> Dict:
        #kwargs['params'] = params
        return self._make_patch_request('patch', url, params, **kwargs)

    def _delete_json(self, url: Text, **kwargs) -> Dict:
        return self._make_json_request('delete', url, **kwargs)
    ...
    def _make_patch_request(self, method: Text, url: Text, params, **kwargs) -> Dict:
        kwargs['headers'] = self._format_headers(kwargs.get('headers', []))
        response = getattr(requests, method)(url, params, **kwargs)
        response.raise_for_status()
        return response.json()
